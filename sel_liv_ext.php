...
if (isset($_POST["GO"])) {
   ...
   for ($i = 0; $i < count($sel); $i++) {
      ...
      $qpr="INSERT INTO plan_ext VALUES('',".$_POST["PID"].", '".$rw[1]."', '".$rw[2]."', ".$rw[3].", 0, '".$rw[5]." - ".$rw[6]."', '".$rw[7]."', '".$rw[8]."', '".$rw[4]."', ".$rw[9].", 0, '', '')";
...
<p align="center"><font size='4' color='#009000'><b>Adaugare Livrari Fitinguri</b></font><br />
...
<b>Zona : </b><select name="zona" size="1" /><option value="0">Viorel</option><option value="1">Rodyca</option><option value="2">Vasile</option></select> <input type='submit' name='FZ' Value='Filtreaza' /> <b>Produs :</b> <input type="text" name="ART" size="25" /> <input type='submit' name='FA' Value='Filtreaza' />
</p>
<?php
if ($_GET["id"] != 0 ) {
...
if (isset($_POST["FZ"])) {
   switch ($_POST["zona"]) {
   case "0":
        $qpr.=" WHERE livrari.client LIKE '%Bistrita Nasaud' OR livrari.client LIKE '%Maramures' OR livrari.client LIKE '%Satu Mare' OR livrari.client LIKE '%Suceava' OR livrari.client LIKE '%Mures' OR livrari.client LIKE '%Harghita' OR livrari.client LIKE '%Bacau' OR livrari.client LIKE '%Brasov' OR livrari.client LIKE '%Covasna' OR livrari.client LIKE '%Botosani' OR livrari.client LIKE '%Iasi' OR livrari.client LIKE '%Vaslui' OR livrari.client LIKE '%Vrancea' OR livrari.client LIKE '%Galati' OR livrari.client LIKE '%Braila' OR livrari.client LIKE '%..'";
	break;
   case "1":
        $qpr.=" WHERE livrari.client LIKE '%Bucuresti' OR livrari.client LIKE '%Tulcea' OR livrari.client LIKE '%Constanta' OR livrari.client LIKE '%Calarasi' OR livrari.client LIKE '%Ialomita' OR livrari.client LIKE '%Buzau' OR livrari.client LIKE '%Prahova' OR livrari.client LIKE '%Ilfov' OR livrari.client LIKE '%Giurgiu' OR livrari.client LIKE '%Dimbovita' OR livrari.client LIKE '%Arges' OR livrari.client LIKE '%Teleorman' OR livrari.client LIKE '%Olt' OR livrari.client LIKE '%Vilcea' OR livrari.client LIKE '%Dolj' OR livrari.client LIKE '%Mehedinti'";
	break;
   case "2":
        $qpr.=" WHERE livrari.client LIKE '%Gorj' OR livrari.client LIKE '%Timis' OR livrari.client LIKE '%Hunedoara' OR livrari.client LIKE '%Sibiu' OR livrari.client LIKE '%Alba' OR livrari.client LIKE '%Cluj' OR livrari.client LIKE '%Salaj' OR livrari.client LIKE '%Arad' OR livrari.client LIKE '%Caras Severin' OR livrari.client LIKE '%Bihor'";
