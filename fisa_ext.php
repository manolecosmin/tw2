...
echo "<b><i>".$rw[3]."</i> Auto nr. </b>".$row[3]." <b>Sofer : </b>".$row[4]."<br /></p>";
...
<td align="center" width="70"><b>Cantitate<br />de livrat</b></td>
<td align="center" width="160"><b>Mod livrare</b></td>
<td align="center" width="60"><b>Ordinea<br />desc.</b></td>
<td align="center" width="160"><b>Livrare la</b></td>
<td align="center" width="160"><b>Colisaj</b></td>
<td align="center" width="100"><b>Total</b></td>
<td align="center" width="100"><b>LOT</b></td>
</tr>
<?php
$tval=0;
...
while ($row=mysql_fetch_row($res)) {
   ...
   echo "<td align='center' width='70'><b>".$row[4]."</b></td>";
   echo "<td align='left' width='160' height='40'>".$row[13]."</td>";
   echo "<td align='center' width='70'>".$row[5]."</td>";
   echo "<td align='left' width='160'>".$row[6]."</td>";
   echo "<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>\r\n";
}
?>
</table>
<p style="margin-left : 2cm; margin-top: 2mm; font-family: Arial; font-size: 12pt; font-weight: bold;"><br />
<b>Responsabil Logistica : _____________________________________________________ <br/>
Responsabil Magazie : _______________________________________________________ </b></p>
</body></html>
