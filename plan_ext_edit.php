...
if (isset($_POST["SAL"])) {
   ...
   $qpr="UPDATE plan_ext SET cant=".$_POST["CANT"].", locat='".$_POST["LOC"]."', dord=".$_POST["ORD"].", data_l='".$cdt1."', data_c='".$cdt2."', factura='".$_POST["DOC"]."', colisaj='".$_POST["COL"]."' WHERE pid=".$_POST["PID"]." AND id=".$_POST["ID"];
...
$res=mysql_query("SELECT * FROM plan_hdr_ext WHERE id=".$_GET["pid"]) or die(mysql_error());
...
//
$result = mysql_query("SELECT * FROM plan_ext WHERE pid=".$_GET["pid"]." AND id=".$_GET["id"]) or die(mysql_error());
$rw=mysql_fetch_row($result);
?>
<p align="left" style="margin-left: 50px;"><b>Client :</b> <?php echo $rw[2];?> &nbsp; 
<b>Produs : </b><?php echo $rw[3];?><br />
...
<input type='submit' name='SAL' value='Salvez' />&nbsp;&nbsp;<input type='submit' name='ANL' value='Anulez' /></p>
</center>
</form>
</body></html>
