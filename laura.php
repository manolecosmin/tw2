...
if(!in_array($_SERVER['HTTP_HOST'],$allowlist)){
...
echo "<form action=\"planuri.php\" method=\"GET\">
<button name=\"status\" value=\"1\">Validare</button>
<button name=\"status\" value=\"3\">Anulare Validare</button>
<button name=\"status\" value=\"2\">Respingere Validare</button>
<input  type=\"hidden\" name=\"id\" value=\"$id\">
<br><textarea name=\"message\" style=\"     margin-top: 2rem;\"></textarea>
</form>";

$message = mysql_query("SELECT * FROM denial_reason WHERE id_transport = ".$_GET['id']);
