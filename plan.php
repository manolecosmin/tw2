...
<center>
<p style="margin: 2px; padding: 2px;"><font size='4' color='#a00000' face='Verdana'><b>Plan de incarcare Intern # <?php echo $_GET["id"];?></b></font></p> 
...
?>
<p style="margin: 2px; padding: 2px;"><b>Data : </b><span class="tMark"><?php echo $row[1];?></span> <b>&bull; Transportator : </b>
<?php
...
echo "</table>\r\n";
echo "<p><b>Valoare totala : </b>".Round($tval,2)." RON (".round(($prvaltr*100)/$tval,2)." %)&nbsp;&nbsp;&nbsp;<a href='sel_liv.php?id=".$_GET["id"]."' class='btn'>Adaugare</a>&nbsp;&nbsp;&nbsp;<a href='planview.php?id=".$_GET["id"]."' class='btn' target='_blank'>Previzualizare</a>&nbsp;&nbsp;&nbsp;<a href='fisa_in.php?id=".$_GET["id"]."' class='btn' target='_blank'>Fisa incarcare</a> &nbsp; <a href='planuri.php' class='btn' target='_blank'> Lista planuri </a><br /></p>";
?>
</center>
</body></html>
